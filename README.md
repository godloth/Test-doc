# Payment-test OpenAPI Specification
[![Build Status](https://travis-ci.org/godloth/Test-doc.svg?branch=master)](https://travis-ci.org/godloth/Test-doc)
...
6. If you did everything correct, https://godloth.github.io/Test-doc/ will lead to your new docs
...
- Documentation(ReDoc): https://godloth.github.io/Test-doc/
- SwaggerUI: https://godloth.github.io/Test-doc/swagger-ui/
- Look full spec:
    + JSON https://godloth.github.io/Test-doc/swagger.json
    + YAML https://godloth.github.io/Test-doc/swagger.yaml
- Preview spec version for branch `[branch]`: https://godloth.github.io/Test-doc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://godloth.github.io/Test-doc/ with url from the message: `Server started <url>`
